    ...
    <div class="md:container md:mx-auto ">
        ...
        <div id="email-verification" class="hidden mt-4 w-96 ">
            <form id="email-form" class="space-y-4">
                ...
                <input type="email" id="email" class="p-2 border border-gray-300 rounded-md"
                    placeholder="Enter your email">
                <button type="submit" class="bg-yellow-700	 text-white p-2 rounded-md">Start Chat</button>
            </form>
        </div>
        <div id="chat-conversation1" class="msg-bubble mb-4 hidden">
